...
const PruefprotokollErfassenPage = lazy(() => import('@/pages/intents/PruefprotokollErfassenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/pruefprotokoll-erfassen" element={<Suspense fallback={null}><PruefprotokollErfassenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
          </ActionsProvider>
