...
// <custom:imports>
const NeuenAuftragPage = lazy(() => import('@/pages/intents/NeuenAuftragPage'));
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/neuen-auftrag" element={<Suspense fallback={null}><NeuenAuftragPage /></Suspense>} />
