...
// <custom:imports>
const AuftragMitPositionenPage = lazy(() => import('@/pages/intents/AuftragMitPositionenPage'));
          ...
          <ActionsProvider>
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/auftrag-mit-positionen" element={<Suspense fallback={null}><AuftragMitPositionenPage /></Suspense>} />
