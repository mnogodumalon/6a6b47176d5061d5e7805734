  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsdatum': (
      <div key="auftragsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="auftragsdatum"
          placeholder="Heute oder Auftragstag"
          mode="date"
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Leistungsumfang, Anforderungen, besondere Wünsche..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wunsch-Deadline (mit Uhrzeit)"
          mode="datetime"
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Geplante Fertigstellung (mit Uhrzeit)"
          mode="datetime"
