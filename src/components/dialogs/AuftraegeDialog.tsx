  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was ist zu tun? Welche Arbeiten, welche Materialien, besondere Anforderungen?"
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann möchte der Kunde fertig sein?"
          mode="datetime"
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Bis wann soll es fertig sein?"
          mode="datetime"
    ...
    'monteur': (
      <div key="monteur" className="space-y-1.5">
        ...
        <Input
          id="monteur"
          placeholder="z. B. Name des Monteurs"
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Besonderheiten, Zugang, Sicherheit, Hinweise..."
