  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was wird gemacht? Material, Ziel, Besonderheiten..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann sollte die Arbeit fertig sein?"
          mode="datetime"
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Wann wird tatsächlich geliefert?"
          mode="datetime"
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Besonderheiten, Zugang, Parkplatz, Kundenwünsche..."
