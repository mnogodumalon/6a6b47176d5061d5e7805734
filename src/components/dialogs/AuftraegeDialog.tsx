  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsdatum': (
      <div key="auftragsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="auftragsdatum"
          placeholder="Heute oder Empfangsdatum?"
          mode="date"
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was soll geleistet werden? Maße, Materialien, besondere Anforderungen..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Bis wann sollte es fertig sein?"
          mode="datetime"
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Geplantes Fertigstellungsdatum"
          mode="datetime"
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Spezielle Anforderungen, Besonderheiten, Baustelleninfo..."
