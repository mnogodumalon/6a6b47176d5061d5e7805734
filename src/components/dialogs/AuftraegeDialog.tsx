  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsdatum': (
      <div key="auftragsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="auftragsdatum"
          placeholder="Wann wird der Auftrag erteilt?"
          mode="date"
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was ist zu arbeiten? Umfang, Anforderungen, Spezifikationen..."
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Geplanter Liefertermin mit Uhrzeit?"
          mode="datetime"
    ...
    'monteur': (
      <div key="monteur" className="space-y-1.5">
        ...
        <Input
          id="monteur"
          placeholder="Wer führt die Arbeit aus?"
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Besonderheiten, Materialwünsche, Kundenangaben..."
