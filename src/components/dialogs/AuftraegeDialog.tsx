  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was soll gemacht werden? Umfang, Anforderungen, Besonderheiten..."
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Spezielle Anforderungen, Anmerkungen..."
