  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was soll erledigt werden? Umfang, Besonderheiten..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Wann soll die Arbeit abgeschlossen sein?"
          mode="datetime"
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Spätestens wann muss es passen?"
          mode="datetime"
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Besonderheiten, Zugang, Materialwünsche..."
