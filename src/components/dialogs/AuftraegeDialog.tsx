  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'auftragsbeschreibung': (
      <div key="auftragsbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was muss getan werden? Material, Umfang, spezielle Anforderungen..."
    ...
    'wunschtermin': (
      <div key="wunschtermin" className="space-y-1.5">
        ...
        <DatePicker
          id="wunschtermin"
          placeholder="Gewünschter Lieferzeitpunkt?"
          mode="datetime"
    ...
    'liefertermin': (
      <div key="liefertermin" className="space-y-1.5">
        ...
        <DatePicker
          id="liefertermin"
          placeholder="Tatsächlicher Lieferzeitpunkt?"
          mode="datetime"
    ...
    'monteur': (
      <div key="monteur" className="space-y-1.5">
        ...
        <Input
          id="monteur"
          placeholder="z. B. Karl Baumeister"
    ...
    'auftrag_notizen': (
      <div key="auftrag_notizen" className="space-y-1.5">
        ...
        <Textarea
          id="auftrag_notizen"
          placeholder="Besonderheiten, Rücksprachen, Rechnungsdetails..."
