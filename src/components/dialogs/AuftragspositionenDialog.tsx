  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'material': (
      <div key="material" className="space-y-1.5">
        ...
        <Combobox
          id="material"
          placeholder="Welches Material wird verwendet?"
    ...
    'positionsbeschreibung': (
      <div key="positionsbeschreibung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Fassadenverkleidung Ostseite"
    ...
    'einheit_position': (
      <div key="einheit_position" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="einheit_position" className="max-sm:h-11"><SelectValue placeholder="Wie wird gemessen?" /></SelectTrigger>
          <SelectContent>
    ...
    'bemerkung': (
      <div key="bemerkung" className="space-y-1.5">
        ...
        <Textarea
          id="bemerkung"
          placeholder="Zuschnittmaße, Oberflächenbehandlung, spezielle Anforderungen..."
