  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'einheit_position': (
      <div key="einheit_position" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="einheit_position" className="max-sm:h-11"><SelectValue placeholder="z. B. Meter, Stück" /></SelectTrigger>
          <SelectContent>
    ...
    'bemerkung': (
      <div key="bemerkung" className="space-y-1.5">
        ...
        <Textarea
          id="bemerkung"
          placeholder="Spezielle Hinweise zur Position, Qualität, Toleranzen..."
