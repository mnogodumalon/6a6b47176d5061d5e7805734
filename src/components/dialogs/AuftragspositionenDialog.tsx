  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'positionsbeschreibung': (
      <div key="positionsbeschreibung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Stahlträger zuschneiden und schweißen"
    ...
    'einheit_position': (
      <div key="einheit_position" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="einheit_position" className="max-sm:h-11"><SelectValue placeholder="Wähle eine Einheit" /></SelectTrigger>
          <SelectContent>
    ...
    'bemerkung': (
      <div key="bemerkung" className="space-y-1.5">
        ...
        <Textarea
          id="bemerkung"
          placeholder="Technische Details, Verarbeitung, Sonderwünsche..."
