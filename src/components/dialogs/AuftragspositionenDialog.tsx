  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'positionsbeschreibung': (
      <div key="positionsbeschreibung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Arbeits- oder Materialleistung"
    ...
    'einheit_position': (
      <div key="einheit_position" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="einheit_position" className="max-sm:h-11"><SelectValue placeholder="Stück, Meter, Kilogramm, ..." /></SelectTrigger>
          <SelectContent>
