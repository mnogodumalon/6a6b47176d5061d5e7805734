  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'auftrag': (
      <div key="auftrag" className="space-y-1.5">
        ...
        <Combobox
          id="auftrag"
          placeholder="Welchem Auftrag zuordnen?"
    ...
    'material': (
      <div key="material" className="space-y-1.5">
        ...
        <Combobox
          id="material"
          placeholder="Welches Material verwenden?"
    ...
    'positionsbeschreibung': (
      <div key="positionsbeschreibung" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Fassaden verputzen"
    ...
    'einheit_position': (
      <div key="einheit_position" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="einheit_position" className="max-sm:h-11"><SelectValue placeholder="z. B. Meter" /></SelectTrigger>
          <SelectContent>
    ...
    'bemerkung': (
      <div key="bemerkung" className="space-y-1.5">
        ...
        <Textarea
          id="bemerkung"
          placeholder="Details zu dieser Position, Verbrauch, Material-Variante..."
