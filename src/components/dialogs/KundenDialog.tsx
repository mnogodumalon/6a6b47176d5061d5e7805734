...
export function KundenDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: KundenDialogProps) {
  ...
  const REQUIRED_FIELDS = ['vorname', 'nachname', 'telefon'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'firma': (
      <div key="firma" className="space-y-1.5">
        ...
        <Input
          id="firma"
          placeholder="z. B. Baumarkt Schmidt"
          value={fields.firma ?? ''}
    ...
    'telefon': (
      <div key="telefon" className="space-y-1.5">
        <Label htmlFor="telefon">Telefon <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="telefon"
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          id="email"
          type="email"
          placeholder="z. B. hans@example.de"
          value={fields.email ?? ''}
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besonderheiten, Kontaktpersonen, Allergien, Vorlieben..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "firma": "Firma", "telefon": "Telefon", "email": "E-Mail", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "notizen": "Notizen"};
