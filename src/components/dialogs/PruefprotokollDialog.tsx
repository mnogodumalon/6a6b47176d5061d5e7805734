  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was wurde beanstandet? Material, Verarbeitung, Maße..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Nachbesserungen, Austausch, Dokumentation..."
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Informationen, Freigabe, nächste Schritte..."
