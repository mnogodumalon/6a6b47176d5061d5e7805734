  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'auftrag_pruef': (
      <div key="auftrag_pruef" className="space-y-1.5">
        ...
        <Combobox
          id="auftrag_pruef"
          placeholder="Welcher Auftrag geprüft?"
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was wurde beanstandet? Fehler, Mängel, Abweichungen..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Wie wird behoben? Reparatur, Austausch, Nachbesserung..."
