  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was wurde beanstandet? Spezifische Abweichungen..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Was muss korrigiert werden? Fristen, Verantwortung..."
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Notizen zum Prüfablauf, Beobachtungen..."
