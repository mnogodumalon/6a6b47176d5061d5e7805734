  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'pruefungsdatum': (
      <div key="pruefungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="pruefungsdatum"
          placeholder="Wann erfolgt die Prüfung?"
          mode="datetime"
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was ist fehlerhaft oder unvollständig?"
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Welche Korrektionen sind nötig? Wer macht es? Bis wann?"
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Hinweise zur Qualitätskontrolle..."
