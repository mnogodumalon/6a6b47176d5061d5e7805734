  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was ist fehlerhaft? Beschreibung der Mängel..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Welche Schritte werden eingeleitet? Reparatur, Nachbearbeitung..."
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Anmerkungen, offene Punkte..."
