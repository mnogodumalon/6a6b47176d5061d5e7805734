  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'pruefungsdatum': (
      <div key="pruefungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="pruefungsdatum"
          placeholder="Wann fand die Prüfung statt?"
          mode="datetime"
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Art und Lage der Mängel..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Reparaturmaßnahmen, Nacharbeiten..."
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Sonstige Anmerkungen zur Prüfung..."
