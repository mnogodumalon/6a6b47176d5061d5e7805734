  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'pruefungsdatum': (
      <div key="pruefungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="pruefungsdatum"
          placeholder="Wann erfolgte die Prüfung?"
          mode="datetime"
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was wurde beanstandet? Fehlertyp, Ort, Details..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Wie wird behoben? Reparatur, Austausch, Timeline..."
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Sonstiges, Unterschrift, Datum..."
