  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Welche Mängel gefunden? Standort, Typ, Beschreibung..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Wie beheben? Reihenfolge, Frist, Verursacher..."
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Weitere Beobachtungen, Notizen..."
