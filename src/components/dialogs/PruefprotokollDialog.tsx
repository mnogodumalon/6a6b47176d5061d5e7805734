  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'auftrag_pruef': (
      <div key="auftrag_pruef" className="space-y-1.5">
        ...
        <Combobox
          id="auftrag_pruef"
          placeholder="Welcher Auftrag wurde geprüft?"
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was wurde beanstandet? Beschreibe die Mängel..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Welche Maßnahmen werden eingeleitet? Wer kümmert sich?"
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zusätzliche Anmerkungen zur Prüfung..."
