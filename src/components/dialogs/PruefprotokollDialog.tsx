  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'pruefungsdatum': (
      <div key="pruefungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="pruefungsdatum"
          placeholder="Wann ist die Prüfung?"
          mode="datetime"
    ...
    'maengelbeschreibung': (
      <div key="maengelbeschreibung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Was ist beanstandet? Konkrete Fehler..."
    ...
    'massnahmen': (
      <div key="massnahmen" className="space-y-1.5">
        ...
        <Textarea
          id="massnahmen"
          placeholder="Was wird zur Behebung eingeleitet?"
    ...
    'bemerkungen_pruef': (
      <div key="bemerkungen_pruef" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Sonstiges, Folgetermine, Besonderheiten..."
