const STATUS_COLOR_MAP: Record<string, string> = {
  ...
  auf_bestellung: 'bg-blue-100 text-blue-700 border-blue-200',
  bestanden_mit_maengeln: 'bg-green-100 text-green-700 border-green-200',
  dringend: 'bg-purple-100 text-purple-700 border-purple-200',
  hoch: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  kilogramm: 'bg-indigo-100 text-indigo-700 border-indigo-200',
  liter: 'bg-teal-100 text-teal-700 border-teal-200',
  meter: 'bg-pink-100 text-pink-700 border-pink-200',
  nicht_verfuegbar: 'bg-red-100 text-red-700 border-red-200',
  niedrig: 'bg-sky-100 text-sky-700 border-sky-200',
  normal: 'bg-violet-100 text-violet-700 border-violet-200',
  paket: 'bg-blue-100 text-blue-700 border-blue-200',
  rolle: 'bg-purple-100 text-purple-700 border-purple-200',
  satz: 'bg-cyan-100 text-cyan-700 border-cyan-200',
  stueck: 'bg-indigo-100 text-indigo-700 border-indigo-200',
};
