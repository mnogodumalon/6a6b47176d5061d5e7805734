...
// <custom:intent-imports>
import { IconClipboardPlus, IconCircleCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neuen-auftrag-erstellen', label: 'Auftrag erstellen', icon: IconClipboardPlus, description: 'Neuen Auftrag mit Kunde und Materialpositionen anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconCircleCheck, description: 'Prüfprotokoll erstellen und Auftrag als abgeschlossen markieren' },
  // </custom:intents>
];
