...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Neuen Auftrag mit Kunde und Positionen anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconCircleCheck, description: 'Auftrag prüfen, Protokoll erfassen und abschließen' },
  // </custom:intents>
];
