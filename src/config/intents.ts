...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Neuen Auftrag mit Positionen anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconClipboardCheck, description: 'Prüfprotokoll erfassen und Auftrag abschließen' },
  // </custom:intents>
];
