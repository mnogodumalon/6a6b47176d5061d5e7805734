...
// <custom:intent-imports>
import { IconFilePlus, IconCircleCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconFilePlus, description: 'Neuen Auftrag mit Positionen anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconCircleCheck, description: 'Prüfprotokoll erstellen und Auftrag abschließen' },
  // </custom:intents>
];
