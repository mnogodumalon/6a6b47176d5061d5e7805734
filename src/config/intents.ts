...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Auftrag in 4 Schritten mit Kunde und Positionen anlegen' },
  { path: '/intents/pruefprotokoll-erfassen', label: 'Prüfprotokoll', icon: IconClipboardCheck, description: 'Prüfprotokoll für einen Auftrag erfassen' },
  // </custom:intents>
];
