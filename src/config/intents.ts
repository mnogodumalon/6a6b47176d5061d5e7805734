...
// <custom:intent-imports>
import { IconClipboardPlus, IconClipboardCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Neuen Auftrag mit Kunde und Materialpositionen anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconClipboardCheck, description: 'Auftrag prüfen, Protokoll anlegen und Status abschließen' },
  // </custom:intents>
];
