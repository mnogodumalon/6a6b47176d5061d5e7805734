...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-mit-positionen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Neuen Auftrag mit Positionen anlegen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconClipboardCheck, description: 'Prüfprotokoll erstellen und Auftrag abschließen' },
  // </custom:intents>
];
