...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Kunden wählen, Auftrag erstellen und Positionen hinzufügen' },
  { path: '/intents/auftrag-abschliessen', label: 'Auftrag abschließen', icon: IconClipboardCheck, description: 'Auftrag prüfen, Protokoll erstellen und abschließen' },
  // </custom:intents>
];
