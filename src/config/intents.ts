...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/auftrag-anlegen', label: 'Auftrag anlegen', icon: IconClipboardPlus, description: 'Neuen Auftrag mit Kunde und Materialien anlegen' },
  { path: '/intents/pruefprotokoll-erstellen', label: 'Prüfprotokoll', icon: IconChecklist, description: 'Prüfprotokoll für einen Auftrag erstellen' },
  // </custom:intents>
];
