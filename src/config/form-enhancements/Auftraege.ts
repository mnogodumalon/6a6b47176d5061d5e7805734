// Auto-generated. Per-entity form-enhancements config for "Aufträge".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['auftragsnummer', 'auftragsdatum', 'status', 'prioritaet', 'kunde', 'auftragsbeschreibung', 'wunschtermin', 'liefertermin', 'monteur', 'auftrag_notizen'],
  defaults: {
    'auftragsdatum': { kind: 'today' },
    'status': { kind: 'lookup', key: 'offen', label: 'Offen' },
    'wunschtermin': { kind: 'todayOffset', days: 3, withTime: true },
    'liefertermin': { kind: 'todayOffset', days: 3, withTime: true },
  },
  computed: {},
};
