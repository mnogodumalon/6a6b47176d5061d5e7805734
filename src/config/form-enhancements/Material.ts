// Auto-generated. Per-entity form-enhancements config for "Material".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['bezeichnung', 'artikelnummer', 'einheit', 'verfuegbarkeit', 'lagerbestand', 'mindestbestand', 'material_notizen'],
  defaults: { 'verfuegbarkeit': { kind: 'lookup', key: 'verfuegbar', label: 'Verfügbar' } },
  computed: {},
};
