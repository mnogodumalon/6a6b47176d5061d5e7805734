// Auto-generated. Per-entity form-enhancements config for "Prüfprotokoll".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['auftrag_pruef', { row: ['monteur_name_vorname', 'monteur_name_nachname'] }, 'pruefungsdatum', 'pruefergebnis', 'maengelbeschreibung', 'massnahmen', 'bemerkungen_pruef'],
  defaults: {
    'pruefungsdatum': { kind: 'today', withTime: true },
    'pruefergebnis': { kind: 'lookup', key: 'nicht_bestanden', label: 'Nicht bestanden' },
  },
  computed: {},
};
